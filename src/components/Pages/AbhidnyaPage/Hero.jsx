    ...
    <>
      <section className="bg-[#0f0f0f] text-white px-5 sm:px-10 lg:px-20 py-16">
        <div className="max-w-6xl mx-auto text-center">
          {/* Title */}
          <h1 className="text-2xl sm:text-3xl lg:text-4xl mb-10 font-extrabold font-heading">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 text-left">
            <div className="py-4 sm:py-0 sm:pr-6 sm:border-r border-white/60">
              <p className="text-white text-lg sm:text-xl font-extrabold font-heading">Role:</p>
              <p className="font-medium font-body text-gray-300 mt-1">UI/UX Designer</p>
            </div>

            <div className="py-4 sm:py-0 sm:px-6 sm:border-r border-white/60">
              <p className="text-white text-lg sm:text-xl font-extrabold font-heading">

                Platform:
              </p>
              <p className="font-medium font-body text-gray-300 mt-1">Website Design</p>
            </div>
            ...
            <div className="py-4 sm:py-0 sm:px-6 sm:border-r border-white/60">
              ...
              <p className="font-medium font-body text-gray-300 mt-1">3 Weeks</p>
            </div>

            <div className="py-4 sm:py-0 sm:pl-6">
              <p className="text-white  text-lg sm:text-xl font-extrabold font-heading">Tools:</p>
              <p className="font-medium font-body text-gray-300 mt-1">Figma</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <h3 className="text-[40px] text-white font-extrabold font-heading">
        Project Overview
      </h3>

      <p className="mt-4 text-[16px] leading-relaxed text-white font-medium font-body">
      ...
      <section className="bg-white px-5 sm:px-10 lg:px-20 py-16">
        <div className="max-w-6xl mx-auto">
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl text-gray-900 mb-10 text-[40px] font-extrabold font-heading">
            Problem & Solution
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-black rounded-xl p-6 shadow-sm hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-extrabold font-heading">Problem</h3>
              </div>

              <p className="text-gray-600 text-sm leading-relaxed font-medium font-body">
            ...
            <div className="bg-white border border-black rounded-xl p-6 shadow-sm hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-extrabold font-heading">Solution</h3>
              </div>
